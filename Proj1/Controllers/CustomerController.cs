...
//        public CustomerController(ICustomerRepository customerRepository, IOrderRepository orderRepository, IDefaultStoreRepository _defaultStoreRepository)
//        {
...
//            var dfs = await _defaultStoreRepository.GetCustomerDefaultStore(id.Value);
//            var customerViewModel = new CustomerViewModel()
//            {
...
//        public async Task<IActionResult> Create([Bind("CustomerID,FirstName,LastName,StreetAddress,CityAddress,StateAddress,CountryAddress,UserName,Email,PassWord,RegDate")] CustomerViewModel customerViewModel)
//        {
...
//                    };
//                    var defaultStore = new DefaultStore()
//                    {
//                        CustomerID = customerViewModel.CustomerID,
//                        StoreID = customerViewModel.StoreID
//                    };
//                    await _defaultStoreRepository.AddDefaultStore(defaultStore);
...
//                        StoreID = customerViewModel.StoreID
//                    };
//                    await _defaultStoreRepository.UpdateDefaultStore(defaultStore);
//                    _customerRepository.UpdateCustomer(customer);
//                }
//                catch (DbUpdateConcurrencyException)
//                {
