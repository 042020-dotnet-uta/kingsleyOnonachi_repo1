...
namespace Proj1.Data
{
    public class SeedData
    {
        ...
        private static void OrderListHelper(Proj1Context context)
        {
        ...
        private static void OrderHelper(Proj1Context context)
        {
        ...
        private static void InventoryHelper(Proj1Context context)
        {
        ...
        private static void DefaultStoreHelper(Proj1Context context)
        {
        ...
        private static void StoreHelper(Proj1Context context)
        {
        ...
        private static void CustomerHelper(Proj1Context context)
        {
