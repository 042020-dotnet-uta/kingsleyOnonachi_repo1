...
namespace P1Test
{
    public class UnitTest1
    {
        ...
        /// <summary>
        /// Testing the update feature of the customer repository
        /// </summary>
        /// <returns></returns>
        [Fact]
        public async Task EditRedirectsToIndex()
        {
            ...
            var controller = new CustomerController(mockRepo.Object, null);
        ...
        public async Task CreateNewRedirectsToIndex()
        {
            ...
            // act
            IActionResult result = controller.Create(new Customer { CustomerID = 1 }).Result;

            // assert
            // ...that the result is a ViewResult
            var viewResult1 = Assert.IsAssignableFrom<RedirectToActionResult>(result);
            // ...that the model of the view is a CustomersViewModel
            Assert.Equal("Index", viewResult1.ActionName);
        }
